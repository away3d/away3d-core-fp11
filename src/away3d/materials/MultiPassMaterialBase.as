package away3d.materials
{
	...
	public class MultiPassMaterialBase extends MaterialBase
	{
		...
		{
			if (distanceBased){
				_distancePass.alphaMask = diffuseMethod.opacityTexture;
				_distancePass.alphaMaskChannel = _diffuseMethod.opacityChannel;
				_distancePass.mipmap = _mipmap;
				_distancePass.repeat = _repeat;
				_distancePass.smooth = _smooth;
			} else {
				_depthPass.alphaMask = diffuseMethod.opacityTexture;
				_depthPass.alphaMaskChannel = _diffuseMethod.opacityChannel;
		...
		override arcane function activateForWorldNormal(stage3DProxy:Stage3DProxy, camera:Camera3D):void {
			_worldNormalPass.opacityMap = _diffuseMethod.opacityTexture;
			_worldNormalPass.opacityChannel = _diffuseMethod.opacityChannel;
			_worldNormalPass.normalMap = normalMap;
			_worldNormalPass.specularIntensity = _specularMethod.specular;
		...
		override arcane function activateForGBuffer(stage3DProxy:Stage3DProxy, camera:Camera3D, drawDepth:Boolean, drawWorldNormals:Boolean, drawAlbedo:Boolean = false, drawSpecular:Boolean = false):void {
			...
			_gBufferPass.colorB = _diffuseMethod.diffuseB;
			_gBufferPass.normalMap = _normalMethod.normalMap;
			_gBufferPass.specularMap = _specularMethod.texture;
			_gBufferPass.specularColorR = _specularMethod._specularR;
			_gBufferPass.specularColorG = _specularMethod._specularG;
			_gBufferPass.specularColorB = _specularMethod._specularB;
			_gBufferPass.gloss = _specularMethod.gloss;
			_gBufferPass.opacityMap = _diffuseMethod.opacityTexture;
			_gBufferPass.opacityChannel = _diffuseMethod.opacityChannel;
			_gBufferPass.specularIntensity = _specularMethod.specular;
