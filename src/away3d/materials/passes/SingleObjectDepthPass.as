...
//			_animationTargetRegisters = Vector.<String>(["vt0", "vt1"]);
		...
		{
			var matrix:Matrix3D;
			var contextIndex:int = stage._stage3DIndex;
			...
			stage.setRenderTarget(_textures[rId], true);
			context.clear(1, 1, 1);
		...
		override public function activate(pass:MaterialPassData, stage:Stage3DProxy, camera:Camera3D):void {
			...
			stage._context3D.setProgramConstantsFromVector(Context3DProgramType.VERTEX, 4, _polyOffset, 1);
		}
	}
}
