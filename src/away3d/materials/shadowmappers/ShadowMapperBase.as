package away3d.materials.shadowmappers
{
	...
	public class ShadowMapperBase
	{
		...
		arcane function renderDepthMap(stage3DProxy:Stage3DProxy, entityCollector:EntityCollector, renderer:DepthRenderer):void
		{
			...
			drawDepthMap(_depthMap, entityCollector.scene, renderer);
		}
		...
		protected function drawDepthMap(target:TextureProxyBase, scene:Scene3D, renderer:DepthRenderer):void
		{
			throw new AbstractMethodError();
		}
	}
