package away3d.materials.methods
{
	 ...
	 */
	public class ShadowHardMethod extends ShadowMethodBase
	{
		/**
		 * Creates a new HardShadowMapMethod object.
		 */
		public function ShadowHardMethod(castingLight:LightBase)
		{
			super(castingLight);
		}
		 ...
		 * @inheritDoc
		 */
		override protected function getPointFragmentCode(methodVO:MethodVO, targetReg:ShaderRegisterElement, regCache:ShaderRegisterCache, sharedRegisters:ShaderRegisterData):String
		{
			var depthMapRegister:ShaderRegisterElement = regCache.getFreeTextureReg();
			var decReg:ShaderRegisterElement = regCache.getFreeFragmentConstant();
