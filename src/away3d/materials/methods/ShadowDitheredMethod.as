package away3d.materials.methods
{
	 ...
	 */
	public class ShadowDitheredMethod extends ShadowMethodBase
	{
		 ...
		 */
		public function ShadowDitheredMethod(castingLight:DirectionalLight, numSamples:int = 4)
		{
			super(castingLight);
        ...
        arcane override function activate(shaderObject:ShaderObjectBase, methodVO:MethodVO, stage:Stage3DProxy):void
		{
			...
			var index:uint = methodVO.fragmentConstantsIndex;
			data[index + 9] = (stage.width - 1)/63;
			data[index + 10] = (stage.height - 1)/63;
			data[index + 11] = 2*_range/_depthMapSize;
			stage.activateTexture(methodVO.texturesIndex + 1, _grainTexture);
		}
		...
		override protected function getPlanarFragmentCode(methodVO:MethodVO, targetReg:ShaderRegisterElement, regCache:ShaderRegisterCache, sharedRegisters:ShaderRegisterData):String
		{
			...
			return getSampleCode(customDataReg, depthMapRegister, decReg, targetReg, regCache, sharedRegisters);
		}
		 ...
		 */
		private function getSampleCode(customDataReg:ShaderRegisterElement, depthMapRegister:ShaderRegisterElement, decReg:ShaderRegisterElement, targetReg:ShaderRegisterElement, regCache:ShaderRegisterCache, sharedRegisters:ShaderRegisterData):String
		{
			var code:String = "";
		...
		override arcane function getCascadeFragmentCode(shaderObject:ShaderObjectBase, methodVO:MethodVO, decodeRegister:ShaderRegisterElement, depthTexture:ShaderRegisterElement, depthProjection:ShaderRegisterElement, targetRegister:ShaderRegisterElement, registerCache:ShaderRegisterCache, sharedRegisters:ShaderRegisterData):String
		{
			...
			return getSampleCode(dataReg, depthTexture, decodeRegister, targetRegister, registerCache, sharedRegisters);
		}
	}
}
