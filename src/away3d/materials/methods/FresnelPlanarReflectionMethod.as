package away3d.materials.methods {
    ...
    public class FresnelPlanarReflectionMethod extends EffectMethodBase {
        ...
        arcane override function activate(shaderObject:ShaderObjectBase, methodVO:MethodVO, stage:Stage3DProxy):void
        {
            ...
            shaderObject.fragmentConstantData[methodVO.fragmentConstantsIndex] = _texture.textureRatioX * .5;
            shaderObject.fragmentConstantData[methodVO.fragmentConstantsIndex + 1] = _texture.textureRatioY * .5;
            shaderObject.fragmentConstantData[methodVO.fragmentConstantsIndex + 3] = _alpha;
            shaderObject.fragmentConstantData[methodVO.fragmentConstantsIndex + 4] = _normalReflectance;
            shaderObject.fragmentConstantData[methodVO.fragmentConstantsIndex + 5] = _fresnelPower;
            if (_normalDisplacement > 0) {
                shaderObject.fragmentConstantData[methodVO.fragmentConstantsIndex + 2] = _normalDisplacement;
                shaderObject.fragmentConstantData[methodVO.fragmentConstantsIndex + 6] = .5 + _texture.textureRatioX * .5 - 1 / _texture.width;
                shaderObject.fragmentConstantData[methodVO.fragmentConstantsIndex + 7] = .5 - _texture.textureRatioX * .5 + 1 / _texture.width;
            }
        }
