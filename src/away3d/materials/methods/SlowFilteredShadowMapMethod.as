package away3d.materials.methods
{
	...
	public class SlowFilteredShadowMapMethod extends ShadingMethodBase
	{
		...
		public function SlowFilteredShadowMapMethod(castingLight : LightBase)
		{
			...
			_data = Vector.<Number>([1.0, 1/255.0, 1/65025.0, 1/160581375.0, -.003, 1/4, castingLight.shadowMapper.depthMapSize, 1/castingLight.shadowMapper.depthMapSize]);
		}
		...
		override arcane function getFragmentPostLightingCode(regCache : ShaderRegisterCache, targetReg : ShaderRegisterElement) : String
		{
			...
			code += AGAL.sub(uvReg+".x", _depthMapVar+".x", dataReg+".w");
			...
			code += AGAL.add(uvReg+".x", uvReg+".x", dataReg+".w");	// (1, 0)
			code += AGAL.sample(depthCol.toString(), uvReg.toString(), "2d", depthMapRegister.toString(), "nearest", "clamp");
			code += AGAL.dp4(depthCol+".z", depthCol.toString(), decReg.toString());
			code += AGAL.sub(depthCol+".z", depthCol+".z", dataReg+".x");	// offset by epsilon
			...
			code += AGAL.add(_viewDirFragmentReg+".w", uvReg+".z", uvReg+".w");
			...
			code += AGAL.add(uvReg+".x", uvReg+".x", dataReg+".w");	// (1, 1)
			code += AGAL.sample(depthCol.toString(), uvReg.toString(), "2d", depthMapRegister.toString(), "nearest", "clamp");
			code += AGAL.dp4(depthCol+".z", depthCol.toString(), decReg.toString());
			code += AGAL.sub(depthCol+".z", depthCol+".z", dataReg+".x");	// offset by epsilon
			code += AGAL.lessThan(uvReg+".w", _depthMapVar+".z", depthCol+".z");   // 0 if in shadow
			...
			code += AGAL.fract(depthCol+".x", depthCol+".x");
			code += AGAL.sub(uvReg+".w", uvReg+".w", _viewDirFragmentReg+".w");
			code += AGAL.mul(uvReg+".w", uvReg+".w", depthCol+".x");
			code += AGAL.add(targetReg+".w", _viewDirFragmentReg+".w", uvReg+".w");
			...
			code += AGAL.sub(uvReg+".y", _depthMapVar+".y", dataReg+".w");
			code += AGAL.sample(depthCol.toString(), uvReg.toString(), "2d", depthMapRegister.toString(), "nearest", "clamp");
			code += AGAL.dp4(depthCol+".z", depthCol.toString(), decReg.toString());
			code += AGAL.sub(depthCol+".z", depthCol+".z", dataReg+".x");	// offset by epsilon
			code += AGAL.lessThan(uvReg+".z", _depthMapVar+".z", depthCol+".z");   // 0 if in shadow
			...
			code += AGAL.mov(uvReg+".x", _depthMapVar+".x");
			code += AGAL.add(uvReg+".y", uvReg+".y", dataReg+".w");	// (0, 1)
			code += AGAL.sample(depthCol.toString(), uvReg.toString(), "2d", depthMapRegister.toString(), "nearest", "clamp");
			code += AGAL.dp4(depthCol+".z", depthCol.toString(), decReg.toString());
			code += AGAL.sub(depthCol+".z", depthCol+".z", dataReg+".x");	// offset by epsilon
			code += AGAL.lessThan(uvReg+".z", _depthMapVar+".z", depthCol+".z");   // 0 if in shadow
			...
			code += AGAL.sub(uvReg+".w", uvReg+".w", _viewDirFragmentReg+".w");
			code += AGAL.mul(uvReg+".w", uvReg+".w", depthCol+".x");
			code += AGAL.add(_viewDirFragmentReg+".w", _viewDirFragmentReg+".w", uvReg+".w");
			code += AGAL.add(targetReg+".w", targetReg+".w", _viewDirFragmentReg+".w");
			...
			code += AGAL.mov(uvReg+".y", _depthMapVar+".y");	// (1, 0)
			code += AGAL.sample(depthCol.toString(), uvReg.toString(), "2d", depthMapRegister.toString(), "nearest", "clamp");
			code += AGAL.dp4(depthCol+".z", depthCol.toString(), decReg.toString());
			code += AGAL.sub(depthCol+".z", depthCol+".z", dataReg+".x");	// offset by epsilon
			code += AGAL.lessThan(uvReg+".z", _depthMapVar+".z", depthCol+".z");   // 0 if in shadow

			code += AGAL.add(uvReg+".x", uvReg+".x", dataReg+".w");	// (2, 0)
			code += AGAL.sample(depthCol.toString(), uvReg.toString(), "2d", depthMapRegister.toString(), "nearest", "clamp");
			code += AGAL.dp4(depthCol+".z", depthCol.toString(), decReg.toString());
			code += AGAL.sub(depthCol+".z", depthCol+".z", dataReg+".x");	// offset by epsilon
			code += AGAL.lessThan(uvReg+".w", _depthMapVar+".z", depthCol+".z");   // 0 if in shadow
			...
			code += AGAL.add(uvReg+".xy", _depthMapVar+".xy", dataReg+".ww");	// (0, 1)
			code += AGAL.sample(depthCol.toString(), uvReg.toString(), "2d", depthMapRegister.toString(), "nearest", "clamp");
			code += AGAL.dp4(depthCol+".z", depthCol.toString(), decReg.toString());
			code += AGAL.sub(depthCol+".z", depthCol+".z", dataReg+".x");	// offset by epsilon
			code += AGAL.lessThan(uvReg+".z", _depthMapVar+".z", depthCol+".z");   // 0 if in shadow
			...
			code += AGAL.mov(uvReg+".x", _depthMapVar+".x");	// (1, 0)
			code += AGAL.sample(depthCol.toString(), uvReg.toString(), "2d", depthMapRegister.toString(), "nearest", "clamp");
			code += AGAL.dp4(depthCol+".z", depthCol.toString(), decReg.toString());
			code += AGAL.sub(depthCol+".z", depthCol+".z", dataReg+".x");	// offset by epsilon
			code += AGAL.lessThan(uvReg+".z", _depthMapVar+".z", depthCol+".z");   // 0 if in shadow

			code += AGAL.add(uvReg+".x", _depthMapVar+".x", dataReg+".w");	// (2, 0)
			code += AGAL.sample(depthCol.toString(), uvReg.toString(), "2d", depthMapRegister.toString(), "nearest", "clamp");
			code += AGAL.dp4(depthCol+".z", depthCol.toString(), decReg.toString());
			code += AGAL.sub(depthCol+".z", depthCol+".z", dataReg+".x");	// offset by epsilon
			code += AGAL.lessThan(uvReg+".w", _depthMapVar+".z", depthCol+".z");   // 0 if in shadow
			...
			code += AGAL.add(uvReg+".y", uvReg+".y", dataReg+".w");	// (0, 1)
			code += AGAL.mov(uvReg+".x", _depthMapVar+".x");	// (2, 0)
			code += AGAL.sample(depthCol.toString(), uvReg.toString(), "2d", depthMapRegister.toString(), "nearest", "clamp");
			code += AGAL.dp4(depthCol+".z", depthCol.toString(), decReg.toString());
			code += AGAL.sub(depthCol+".z", depthCol+".z", dataReg+".x");	// offset by epsilon
			code += AGAL.lessThan(uvReg+".z", _depthMapVar+".z", depthCol+".z");   // 0 if in shadow
			...
			code += AGAL.mul(targetReg+".w", targetReg+".w", dataReg+".y");
