package away3d.materials.methods
{
	 ...
	 */
	public class EffectRimLightMethod extends EffectMethodBase
	{
		 ...
		 */
		public function EffectRimLightMethod(color:uint = 0xffffff, strength:Number = .4, power:Number = 2, blend:String = "mix")
		{
			super();
			_blendMode = blend;
			_strength = strength;
