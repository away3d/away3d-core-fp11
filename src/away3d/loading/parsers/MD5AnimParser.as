package away3d.loading.parsers
{
	...
	public class MD5AnimParser extends ParserBase
	{
		 ...
		 */
		public function MD5AnimParser(uri : String, additionalRotationAxis : Vector3D = null, additionalRotationRadians : Number = 0)
		{
		...
		override protected function initHandle() : IResource
		{
			...
			_sequence.name = index < 0 ? uri : uri.substring(index + 1, uri.length);
			return _sequence;
		}
