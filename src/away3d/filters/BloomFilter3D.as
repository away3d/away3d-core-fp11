package away3d.filters {
    ...
    public class BloomFilter3D extends Filter3DBase {
        ...
        override public function setRenderTargets(mainTarget:TextureProxyBase):void
        {
            _brightPassTask.target = _hBlurTask.getMainInputTexture();
            _hBlurTask.target = _vBlurTask.getMainInputTexture();
            _vBlurTask.target = _compositeTask.getMainInputTexture();
            // use bright pass's input as composite's input
            _compositeTask.overlayTexture = _brightPassTask.getMainInputTexture() as Texture2DBase;

            super.setRenderTargets(mainTarget);
        }
