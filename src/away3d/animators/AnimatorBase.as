package away3d.animators {
    ...
    public class AnimatorBase extends NamedAssetBase implements IAnimator {
        ...
        public function setRenderState(shaderObject:ShaderObjectBase, renderable:RenderableBase, stage3DProxy:Stage3DProxy, camera:Camera3D, vertexConstantOffset:int, vertexStreamOffset:int):void
        {
         ...
         * @inheritDoc
         */
        public function testGPUCompatibility(shaderObject:ShaderObjectBase):void
        {
            throw new AbstractMethodError();
        }
