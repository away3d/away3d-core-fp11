package away3d.animators
{
	...
	public class VertexAnimator extends AnimatorBase implements IAnimator
	{
		...
		private function setNullPose(stageGL:Stage3DProxy, renderable:RenderableBase, vertexConstantOffset:int, vertexStreamOffset:int)
		{
			stageGL.context3D.setProgramConstantsFromVector(Context3DProgramType.VERTEX, vertexConstantOffset, _weights, 1);
