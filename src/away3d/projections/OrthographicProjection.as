package away3d.projections
{
	...
	/**
	 * The OrthographicProjection object provides a projection matrix that projects 3D geometry isometrically. This entails
	 * there is no perspective distortion, and lines that are parallel in the scene will remain parallel on the screen.
	 */
	public class OrthographicProjection extends ProjectionBase
	{
		 ...
		 */
		public function OrthographicProjection(projectionHeight:Number = 500)
		{
			super();
