package away3d.projections
{
	...
	/**
	 * The OrthographicOffCenterProjection object provides a projection matrix that projects 3D geometry isometrically. This entails
	 * there is no perspective distortion, and lines that are parallel in the scene will remain parallel on the screen.
	 */
	public class OrthographicOffCenterProjection extends ProjectionBase
	{
		 ...
		 */
		public function OrthographicOffCenterProjection(minX:Number, maxX:Number, minY:Number, maxY:Number)
		{
			super();
			_minX = minX;
			_maxX = maxX;
		...
		{
			var clone:OrthographicOffCenterProjection = new OrthographicOffCenterProjection(_minX, _maxX, _minY, _maxY);
			clone._near = _near;
			clone._far = _far;
