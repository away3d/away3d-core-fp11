package away3d.textures {
    ...
    public class SpecularBitmapTexture extends BitmapTexture {
        ...
        override arcane function getTextureData():BitmapData
        {
            ...
            _bitmapData.fillRect(rect, 0xffffff);

            if (_glossMap)
                _bitmapData.copyChannel(_glossMap, rect, origin, BitmapDataChannel.GREEN, BitmapDataChannel.GREEN);

            if (_specularMap)
                _bitmapData.copyChannel(_specularMap, rect, origin, BitmapDataChannel.RED, BitmapDataChannel.RED);
