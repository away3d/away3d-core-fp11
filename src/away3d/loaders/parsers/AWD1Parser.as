package away3d.loaders.parsers
{
	...
	public class AWD1Parser extends ParserBase
	{
		...
		override arcane function resolveDependency(resourceDependency:ResourceDependency):void
		{
			...
			if (m && asset) {
                TriangleMethodMaterial(m.material).texture = asset;
			}
		}
			...
			if (_charIndex >= _stringLength) {
				...
				for (i = 0; i < _objs.length; ++i) {
					...
					if (ref && ref.geo) {
						...
						if (materialMode < 2)
							mesh.material = new TriangleMethodMaterial(DefaultMaterialManager.getDefaultTexture());
						else {
                            mesh.material = new TriangleMethodMaterial(DefaultMaterialManager.getDefaultTexture());
                            (mesh.material as TriangleMethodMaterial).materialMode = TriangleMaterialMode.MULTI_PASS;
                        }
