package away3d.tools.commands
{
	...
	*/
	public class Weld {
		...
		* @param normalAngleDegree	Threshold to compair the normals. Default is true.
		...
		*/
		...
		public function apply(mesh : Mesh, keepUvs : Boolean = true, normalAngleDegree : Number = 0, useNormalMode: String = USE_FACENORMALS, smoothNormals:Boolean = true) : void
		{
			_keepUvs = keepUvs;
		...
		* @param smoothNormals 		Smooth. Default is true.
		*/
		public function applyToContainer(obj : ObjectContainer3D, keepUVs : Boolean = true, normalAngleDegree : Number = 0, useNormalMode: String = USE_FACENORMALS,  smoothNormals:Boolean = true) : void
		{
			_keepUvs = keepUVs;
			_useNormalMode = useNormalMode;
			_smoothNormals = smoothNormals;
