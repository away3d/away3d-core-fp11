package away3d.core.base
{
	...
	public interface ISubGeometry
	{
		 ...
		 */
		function get SecondaryUVData():Vector.<Number>;
		...
		function get autoGenerateDummyUVs():Boolean;
		
		function set autoGenerateDummyUVs(value:Boolean):void;
		
		function get hasSecondaryUVs():Boolean;
		
		function set hasSecondaryUVs(value:Boolean):void;
