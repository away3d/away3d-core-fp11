...
//			_context.clear(0, 0, 0, 0, 1, 0);
		...
		private function getApproximatePosition(camera : Camera3D) : void
		{
			...
			_stage3DProxy.setSimpleVertexBuffer(0, _hitRenderable.getVertexBuffer(_stage3DProxy), Context3DVertexBufferFormat.FLOAT_3, _hitRenderable.vertexBufferOffset);
