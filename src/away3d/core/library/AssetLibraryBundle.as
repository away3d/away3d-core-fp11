package away3d.core.library
{
	 ...
	 */ public class AssetLibraryBundle extends EventDispatcher
	{
		 ...
		 * be renamed.
		 *
		 * @see away3d.core.library.ConflictStrategy
		 * @see away3d.core.library.AssetLibrary.conflictPrecedence
		 */
		 ...
		 *
		 * @see away3d.core.library.ConflictPrecedence
		 * @see away3d.core.library.ConflictStrategy
		 */
		 ...
		 *
		 * @see away3d.core.library.AssetType
		 */
		 ...
		 * @param dispose Defines whether the assets should also be disposed.
		 *
		 * @see away3d.core.library.AssetLibrary.removeAsset()
		 */
		...
		private function onAssetRename(ev:AssetEvent):void
		{
			...
			if (old != null)
				_strategy.resolveConflict(asset, old, _assetDictionary[asset.assetNamespace], _strategyPreference); else {
