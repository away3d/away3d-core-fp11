package away3d.core.library
{
	...
	public class AssetLibrary
	{
		 ...
		 *
		 * @see away3d.core.library.AssetLibraryBundle.conflictStrategy
		 */
		 ...
		 *
		 * @see away3d.core.library.AssetLibraryBundle.conflictPrecedence
		 */
		 ...
		 *
		 * @see away3d.core.library.AssetLibraryBundle.createIterator()
		 */
		 ...
		 *
		 * @see away3d.core.library.AssetLibraryBundle.load()
		 */
		 ...
		 *
		 * @see away3d.core.library.AssetLibraryBundle.loadData()
		 */
		 ...
		 *
		 * @see away3d.core.library.AssetLibraryBundle.getAsset()
		 */
		 ...
		 *
		 * @see away3d.core.library.AssetLibraryBundle.addAsset()
		 */
		 ...
		 *
		 * @see away3d.core.library.AssetLibraryBundle.removeAsset()
		 */
		 ...
		 * @param dispose Defines whether the assets should also be disposed.
		 *
		 * @see away3d.core.library.AssetLibraryBundle.removeAssetByName()
		 */
		 ...
		 * @param dispose Defines whether the assets should also be disposed.
		 *
		 * @see away3d.core.library.AssetLibraryBundle.removeAllAssets()
		 */
		 ...
		 *
		 * @see away3d.core.library.AssetLibraryBundle.removeNamespaceAssets()
		 */
